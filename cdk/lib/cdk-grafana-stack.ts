...
interface MyGrafanaStackProps extends cdk.StackProps {
      vpc: Vpc;
}

export class CdkGrafanaStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: MyGrafanaStackProps) {
    ...
    const fargateService = new ecs_patterns.ApplicationLoadBalancedFargateService(this, "GrafanaService", {
